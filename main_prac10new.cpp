		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix();
					...
					glRotatef(180, 0, 1, 0);                   //primera llanta
					glRotatef(movKit, 1, 0, 0);
					llanta.GLrender(NULL,_SHADED,1.0);
				glPopMatrix();

				glPushMatrix();
					glTranslatef(7.5, 0, -9);
					glRotatef(180, 0, 1, 0);                   //segunda llanta
					glRotatef(movKit, 1, 0, 0);
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();
				...
				glPushMatrix();
					glTranslatef(-7.5, 0, -9);
					glRotatef(movKit, 1, 0, 0);                     //tercera llanta
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();

				glPushMatrix();
					glTranslatef(-7.5, 0, 9);
					glRotatef(movKit, 1, 0, 0);				          //cuarta llanta
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();
