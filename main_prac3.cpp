//Semestre 2017 - 2
//Villegas Guerrero Yovany Rafael //
//practica 3//
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	prisma();
	glTranslatef(0.0f, 1.0f, 0.0f);   //estas instrucciones crean la letra C
	prisma();
	glTranslatef(0.0f, 1.0f, 0.0f);
	prisma();
	glTranslatef(0.0f, 1.0f, 0.0f);
	...
	prisma();
	glTranslatef(0.0f, -1.0f, 0.0f);   //estas instrucciones crean la letra G
	prisma();
	glTranslatef(0.0f, -1.0f, 0.0f);
	prisma();
	glTranslatef(0.0f, -1.0f, 0.0f);
