//Semestre 2017 - 2
//practica n 9  transparencia //
//************************************************************//
//Alumno (s): Villegas Guerrero Yovany Rafael //
//Fecha de Entrega : 2 abril de 2019							******//
//*************											******//
//************************************************************//
//************************************************************//
...
CTexture carita; //carita
CTexture tronco; //tronco del arbol de navidad
CTexture pino; //pino de navidad 
CTexture regalo1; //forro del primer regalo
CTexture regalo2; // envoltura del segundo regalo
CTexture regalo3; //envoltura del tercer regalo
CTexture esfera1; 
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	pino.LoadTGA("pino.tga");
	pino.BuildGLTexture();
	pino.ReleaseImage();

	regalo1.LoadTGA("regalo1.tga");
	regalo1.BuildGLTexture();
	regalo1.ReleaseImage();

	regalo2.LoadTGA("regalo2.tga");
	regalo2.BuildGLTexture();
	regalo2.ReleaseImage();

	regalo3.LoadTGA("regalo3.tga");
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		fig1.cilindro(0.2, 5, 30, tronco.GLindex);
		glTranslatef(0, 1, 0);
		fig1.cono(10, 3, 30, pino.GLindex);
		glTranslatef(-4, 0, 0);
		fig1.prisma(1, 1, 1, regalo1.GLindex);
		glTranslatef(8, 0, 0);
		fig1.prisma(1, 1, 1, regalo2.GLindex);
		...
		fig1.prisma(1, 1, 1, regalo3.GLindex);
		   ...
		   glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
		   glTranslatef(2, 2, 0);
		   fig1.esfera(.2, 20, 20, esfera1.GLindex);
		   glTranslatef(-.5, 0, -2);
		   fig1.esfera(.2, 20, 20, esfera1.GLindex);
		   glTranslatef(.3, 1, 1);
		   fig1.esfera(.2, 20, 20, esfera1.GLindex);
